from ..models.otheractions import *
...
def list_applications(input: ListApplicationsInput):
    ...
    return get_wrapper("/applications", params=params)

@action_store.kubiya_action()
def sync_app(input: SyncName):
    return get_wrapper(f"/applications{input.name}/sync")
