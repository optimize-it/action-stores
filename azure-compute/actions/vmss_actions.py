    ...
    try:
        ...
        vmss_data = {
                        ...
                        "properties": {
                            ...
                            "osProfile": {
                                "computerNamePrefix": params.vmssName,
                            ...
                            "networkProfile": {
                                "networkInterfaceConfigurations": [
                                {
                                    ...
                                    "ipConfigurations": [
                                        ...
                                        "properties": {
                                            "subnet": {
                                            "id": f"/subscriptions/{subscriptionId}/resourceGroups/{params.resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{params.vnetName}/subnets/{params.subnetName}"
                                            }
                                        }
                                        }
                                    ]
        ...
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}"
        api_version = "2023-07-01"

        response_data = put_wrapper(endpoint, api_version, data=vmss_data)
...
def list_all_virtual_machines_scale_set(params: VMSSListParameters) -> List[VirtualMachineSSListModel]:
    try:
        endpoint = f"/providers/Microsoft.Compute/virtualMachineScaleSets"
        api_version = "2023-07-01"
...
def list_all_instances_virtual_machines_scale_set(params: ListInstancesParameters) -> List[ListInstancesResponseModel]:
    try:
        endpoint = f"/resourceGroups/{params.resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{params.vmssName}/virtualMachines"
        api_version = "2023-07-01"
...
def deallocate_virtual_machine_scaleset(params: VMSSQueryParameters):
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/Deallocate"
        api_version = "2023-07-01"
        response_data = post_wrapper(endpoint,  api_version)
        if 200 <= response_data < 300:
            return {"Request successfully accepted with status code": response_data}
    except Exception as e:
...
def restart_virtual_machine_scaleset(params: VMSSQueryParameters):
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/Restart"
        api_version = "2023-07-01"
        response_data = post_wrapper(endpoint,  api_version)
        if 200 <= response_data < 300:
            return {"Request successfully accepted with status code": response_data}
...
def start_virtual_machine_sccaleset(params: VMSSQueryParameters):
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/Start"
        api_version = "2023-07-01"
        response_data = post_wrapper(endpoint,  api_version)
        if 200 <= response_data < 300:
            return {"Request successfully accepted with status code": response_data}
...
def redeploy_virtual_machine_scaleset(params: VMSSQueryParameters):
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/redeploy"
        api_version = "2023-07-01"
        response_data = post_wrapper(endpoint,  api_version)
        if 200 <= response_data < 300:
            return {"Request successfully accepted with status code": response_data}
...
def list_by_location_virtual_machines_scaleset(params: VMSSGetParametersByLocation) -> List[VirtualMachineSSListModel]:
    try:
        endpoint = f"/providers/Microsoft.Compute/locations/{params.location}/virtualMachineScaleSets"
        api_version = "2023-03-01"
...
def instance_view_virtual_machine_scaleset(params: VMSSQueryParameters) -> Union[VirtualMachineScaleSetInstanceViewResponseModel, dict] :
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/instanceView"
        api_version = "2023-07-01"
        response_data = get_wrapper(endpoint,  api_version)
...
def delete_instance_of_virtual_machine_scaleset(params: VMSSInstanceDeleteParameters):
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/virtualMachines/{params.instanceId}"
        api_version = "2023-07-01"
        response_data = delete_wrapper(endpoint,  api_version)
        return VirtualMachineSSResponseModel(**response_data)
    except Exception as e:
...
def power_off_virtual_machine_scale_set(params: VMSSInstanceQueryParameters):
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        # /resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmssName}/poweroff"
        api_version = "2023-07-01"
        response_data = post_wrapper(endpoint,  api_version)
        return response_data
    except Exception as e:
...
def list_sku_virtual_machine_scale_set(params: VMSSQueryParameters):
    try:
        ...
        resourceGroupName = params.resourceGroupName
        vmssName = params.vmssName
        endpoint = f"/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachinesScaleSets/{vmssName}/skus"
        api_version = "2023-07-01"
        response_data = get_wrapper(endpoint,  api_version)
        return response_data
    except Exception as e:
