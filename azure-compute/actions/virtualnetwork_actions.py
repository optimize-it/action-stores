...
def create_or_update_virtual_network(params: VNETCreationParameters) -> Union[VnetResponseModel, dict]:
...
@action_store.kubiya_action()
def listall_azure_Vnets(params: VnetListParameters) -> Union[VnetListModel, dict]:
    #subscriptionId = params.subscriptionId
...
def list_by_rg_azure_Vnets(params: VnetListParameters) -> Union[VnetListModel, dict]:
    #subscriptionId = params.subscriptionId
...
def delete_azure_Vnets(params: VnetDeleteParameters):
    #subscriptionId = params.subscriptionId
